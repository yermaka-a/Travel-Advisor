...
import { IExtDataManager, ISearchingPlacesProps, THints } from "./types"
...
export const SearchingPlaces = ({ sx }: ISearchingPlacesProps) => {
    ...
    return (
        <Box sx={sx ? { ...classes.search, ...(Array.isArray(sx) ? sx : [sx]) } : classes.search} display="flex">
